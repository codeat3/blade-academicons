...
use Codeat3\BladeAcademicons\BladeAcademiconsServiceProvider;
...
class CompilesIconsTest extends TestCase
{
    ...
    {
        $result = svg('academicon-zotero')->toHtml();
    ...
    {
        $result = svg('academicon-zotero', 'w-6 h-6 text-gray-500')->toHtml();
        $expected = <<<'SVG'
    ...
    {
        $result = svg('academicon-zotero', ['style' => 'color: #555'])->toHtml();
    ...
    {
        Config::set('blade-academicons.class', 'awesome');
    ...
    public function it_can_merge_default_class_from_config()
    {
        ...
        $result = svg('academicon-zotero', 'w-6 h-6')->toHtml();
    ...
    protected function getPackageProviders($app)
    {
        return [
            ...
            BladeAcademiconsServiceProvider::class,
        ];
    }
}
